            ...
            <div className="flex-1">
              <div className="flex items-center justify-between gap-4">
                ...
                <button
                  ...
                  className={`relative inline-flex h-7 w-12 flex-shrink-0 items-center rounded-full p-1 shadow-inner transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500/60 ${
